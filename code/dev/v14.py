...
class GIFRecorder(QWidget):
    ...
    def initUI(self):
        ...
        titleLayout.addStretch()
        titleLayout.addWidget(self.settingsButton)
    ...
    def record_screen(self):
        while self.is_recording:
            ...
            screen = ImageGrab.grab(bbox=(x + self.resize_margin, y + 15 + self.titleBar.height() + self.resize_margin, x + w - self.resize_margin, y + h - self.resize_margin))
