...
class GIFRecorder(QWidget):
    ...
    def stop_recording(self):
        ...
        if filePath:
            ...
            numpy_frames = [np.array(frame) for frame in self.frames]
            imageio.mimsave(filePath, numpy_frames, duration=1/self.frame_rate, loop=0)  # Set loop=0 for infinite loop
